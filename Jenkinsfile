    ...
    stages {
        ...
        stage ("sonar-scanner") {
            ...
            steps {
                ...
                sh ''' mvn clean verify sonar:sonar -Dsonar.projectKey=/var/lib/jenkins/workspace/ews-project/ews-service-registry -Dsonar.host.url=${SONAR_URL} -Dsonar.login=$SONAR_AUTH_TOKEN \''''
